...
<table class='table table-bordered'>        
	    ...
	    <tr><td width='200'>Id Kategori <?php echo form_error('id_kategori') ?></td><td><?php echo cmb_dinamis('id_kategori', 'kategori_pembayaran','nama_kategori','id',$id_kategori) ?></td></tr>
	    ...
	    <tr><td width='200'>Unit <?php echo form_error('id_tahun_angkatan') ?></td><td><?php echo cmb_dinamis('id_tahun_angkatan', 'groups','name','id',$id_tahun_angkatan) ?></td></tr>
