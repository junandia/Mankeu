...
<table class='table table-bordered'>        
	    ...
	    <tr><td width='200'>Unit <?php echo form_error('id_unit') ?></td><td><?php echo cmb_dinamis('id_unit','master_unit','nama_unit','id') ?></td></tr>
	    <tr><td width='200'>Angkatan <?php echo form_error('id_angkatan') ?></td><td><?php echo cmb_dinamis('id_angkatan','tahun_angkatan','tahun_angkatan','id') ?></td></tr>
